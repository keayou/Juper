...
+ (HXPhotoManager *)getPhotoPickerConfig
{
    ...
    
    {
        ...
        pickerManager.configuration.clarityScale = 2.0;
        pickerManager.configuration.photoMaxNum = 1;
        pickerManager.configuration.rowCount = 3;
        pickerManager.configuration.saveSystemAblum = YES;
        pickerManager.configuration.reverseDate = YES;
...
//        pickerManager.configuration.creationDateSort = NO;
